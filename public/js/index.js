$.getJSON( "https:bitbucket.org/nadjib-l1nda/front-end-test/raw/30ffd45f11ad684579e70123f253ea20d0e7befc/data.json", function(data) {
  ...
  $.each(data, function(key, val) {
    ...
    var h5   = "<button class='btn btn-outline-primary' type='button'><h5 class='days-button'>" + data[key].date + "</h5>";
    ...
    var p4   = "<p>" + 'Week day: ' + data[key].weekday + "</p><div></button></div>";

    $("#dates").append(h5+div1+p1+p2+p3+div2+p11+p12+p13+p14+p4);
